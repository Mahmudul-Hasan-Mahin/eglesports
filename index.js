...
const token = config.TOKEN; //EGL ESPORTS
...
bot.on("ready", () => {
  ...
  bot.user.setActivity(`EGL DAILY SCRIM`, {url: "https://github.com",type: "WATCHING"}); //Type "PLAYING","WATCHING","STREAMING","LISTENING"
});

//var version = '1.0.1'
//Welcome EGL ESPORTS
bot.on('guildMemberAdd', member => {
  const channel = member.guild.channels.find(c => c.id === config.WLCCHANNELID); // change this to the channel name you want to send the greeting to
  if (!channel) return;
